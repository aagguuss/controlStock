 ...
 * @author agust
 */
public class MenuIngreso extends JFrame {
    ...
    public static void avisar(String string) {
    ...
    public MenuIngreso() throws Exception {
        ...
        txtPassword.setName("Contraseña");
    ...
    private void initComponents() {
        ...
        JButton btnAceptar2 = new JButton();
        jPanel1 = new JPanel();
        ...
        btnAceptar2.setBorder(BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        ...
        jPanel1.setBorder(BorderFactory.createCompoundBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), BorderFactory.createTitledBorder("")));
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addComponent(jPanel1, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 402, Short.MAX_VALUE)
        );
    ...
    private void txtPasswordFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPasswordFocusLost
        String concatpass = new String(txtPassword.getPassword());

        if (concatpass.isEmpty() || concatpass.equals("Contraseña")) {
            addPlaceHolderStyle(txtPassword);
            txtPassword.setText("Contraseña");
            txtPassword.setEchoChar('\u0000');
        }
        ...
        try {
            ...
            if (mensaje.equalsIgnoreCase("Entrando 4l $istema")) {
                try {
                    ...
                    avisar("Error en la line 198 : " + e.getMessage());
                }
            }
        } catch (Exception ex) {
            /*Logger.getLogger(MenuIngreso.class.getName()).log(Level.SEVERE, null, ex);*/
            avisar("Error en la line 206 : " + ex.getMessage());
            ex.printStackTrace();
        }
