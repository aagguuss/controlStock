...
public class UsuarioDao {
    ...
    public List<Usuario> listarTodos() throws Exception {
        conectar();
        List<Usuario> usuarios = em.createQuery("SELECT l FROM Usuario l", Usuario.class).getResultList();
        desconectar();
        return usuarios;
    }
    ...
    public void activarUsuario(Usuario u) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al Activar Usuario " + u.getName() + ": " + e.getMessage());
        } finally {
            desconectar();
        }
    ...
    public void desactivarUsuario(Usuario u) {
        ...
        try {
            ...
            if (em.contains(uPersist)) {
                ...
                JOptionPane.showMessageDialog(null, "No se pudo desactivar el usuario ya que upersist no esta en base de datos");
            }
    ...
    public Usuario buscarPorNombreContraseña(String nombre, String contraseña) {
        ...
        try {
            conectar();
            usuarioEspecifico = em.createQuery("SELECT u FROM Usuario u WHERE u.name = :nombre AND u.password = :contrasena", Usuario.class)
